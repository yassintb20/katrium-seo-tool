                ...
                with st.expander(f"{lang}  {prio}  —  {brief.get('query','').title()}  ·  {brief.get('impressions',0):,} impr/mo"):
                    ...
                    with c1:
                        ...
                        <div style="background:#0d1117;border-radius:8px;padding:1rem;margin-bottom:0.8rem;border:1px solid #1e2d40;">
                            <div style="color:#6b7ea3;font-size:0.72rem;font-weight:600;text-transform:uppercase;letter-spacing:0.05em;margin-bottom:0.4rem;">Slug</div>
                        ...
                        <div style="background:#0d1117;border-radius:8px;padding:1rem;margin-bottom:0.8rem;border:1px solid #1e2d40;">
                            ...
                            <div style="color:#e6edf3;font-size:0.88rem;font-weight:500;">{brief.get('title_tag','')}</div>
                        </div>
                        <div style="background:#0d1117;border-radius:8px;padding:1rem;margin-bottom:0.8rem;border:1px solid #1e2d40;">
                        ...
                        <div style="display:flex;gap:1rem;font-size:0.82rem;">
                            <div><span style="color:#6b7ea3;">Target:</span> <span style="color:#e6edf3;">{brief.get('word_count_target','')}</span></div>
